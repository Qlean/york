...
var StyledMenyItem = _styledComponents["default"].div.withConfig({
  displayName: "Menu__StyledMenyItem",
  componentId: "sc-1mqwwss-3"
})(["display:flex;", ""], _styles.media.mobile("\n    display: block;\n  "));
...
var Menu = function Menu(_ref3) {
  ...
  return _react["default"].createElement(StyledMenuWrapper, {
    ...
    return _react["default"].createElement(StyledMenyItem, null, category.isMobileTitleHidden || _react["default"].createElement(StyledCategoryTitle, {
      preset: "h5",
      color: "grey"
      ...
      return _react["default"].createElement(StyledFloatingLink, {
        ...
        color: _utils.presets[preset].floatingLink,
        hoverColor: _utils.presets[preset].floatingLinkHover,
